...
internal class YuriLab(context: MangaLoaderContext) :
    MadaraParser(context, MangaParserSource.YURILAB, "yurilabs.my.id", pageSize = 20, searchPageSize = 10) {
    ...
    override suspend fun getDetails(manga: Manga): Manga {
        ...
        val parsedTags = docs.select("div.genres-content a").map { it.text() }.toSet()
