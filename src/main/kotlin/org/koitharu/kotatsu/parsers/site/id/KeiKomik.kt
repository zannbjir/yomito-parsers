...
internal class Keikomik(context: MangaLoaderContext) :
    ...
    override suspend fun getListPage(page: Int, order: SortOrder, filter: MangaListFilter): List<Manga> {
        ...
        val rawList: List<Manga> = doc.select("div.manga-card, .manga-item, article, .series-item").mapNotNull<Element, Manga> { el ->
    ...
    override suspend fun getDetails(manga: Manga): Manga {
        ...
        val chapters: List<MangaChapter> = doc.select("a.chapter-link, li.chapter a, .episode-list a").mapNotNull<Element, MangaChapter> { a ->
